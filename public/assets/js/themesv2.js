(() => {
    var e,
        ...
        i,
        s,
        r = document.getElementById("pmvjap"),
    ...
    displayCountdown = function (e) {
        ...
        var t = new Date("Dec 07, 2024 09:00:00 GMT+0700").getTime(),
            ...
            i = setInterval(function () {
                var e = new Date().getTime(),
                    s = t - e,
                    r = Math.floor(s / 864e5), // Calculate days
                    c = Math.floor((s % 864e5) / 36e5), // Calculate hours
                    d = Math.floor((s % 36e5) / 6e4), // Calculate minutes
                    u = Math.floor((s % 6e4) / 1e3); // Calculate seconds
                (n.innerHTML = r),
                    (o.innerHTML = c),
                    (a.innerHTML = d),
                    (l.innerHTML = u),
    ...
    $();
    var ee = document.querySelectorAll(".pmvjap_slide"),
        te = document.querySelectorAll(".pmvjap_menu_item"),
        ne = document.getElementById("smMenu"),
        oe = document.querySelector(".pmvjap_menu_list"),
